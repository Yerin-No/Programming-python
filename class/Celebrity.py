class Celebrity:
    ...
    def __str__(self):
        return f'이름: {self.name}\t소속사: {self.entertainment}'    #<__main__Celebrity object at 0x000...>
...
Jenny = Celebrity('김제니')
#Jenny.set_name('김제니')
Jenny.set_entertainment('YG')
# Jenny.info()
print(Jenny.name,Jenny.entertainment)
print(Jenny)
